...
| S14 | 医疗政策影响速读 | 医疗 | ★★★ | 标准难度 | 90min | [S14-medical-policy-impact.md](S14-medical-policy-impact.md) |
| S15 | 商业物业盘活方案对比 | 地产 | ★★★ | 标准难度 | 90min | [S15-real-estate-asset-review.md](S15-real-estate-asset-review.md) |
| S16 | TMT 产品发布会跟进 | TMT | ★★★ | 标准难度 | 90min | [S16-tmt-product-launch.md](S16-tmt-product-launch.md) |
| S17 | 咨询启动会前的行业 Quick Look | 咨询 | ★★ | 翻车机会少，适合快速体验迭代流程 | 90min | [S17-consulting-quicklook.md](S17-consulting-quicklook.md) |
...
### 如果您来自医疗 / 医药 / 医疗器械行业
优先选择：S14（医疗政策影响），可对比参考 S7（政策影响通用版）

### 如果您来自地产 / 物业 / 资产管理
优先选择：S15（商业物业盘活），也可参考 S6（商业模式画布）

### 如果您来自 TMT / 互联网 / 智能硬件
优先选择：S16（TMT 产品发布跟进），也可参考 S8（竞品功能对比）

### 如果您来自咨询 / 投行 / FA / 卖方研究
优先选择：S17（咨询启动会 Quick Look），也可参考 S13（调研报告生成）
...
>
> S7（政策影响评估）与 S14（医疗政策影响）方法论相通但行业不同：S7 用新能源 / 跨境政策做素材，S14 用医保集采 + UDI 做素材。两组同时选会更突出"同一种 Harness 思路在不同行业的迁移性"。
